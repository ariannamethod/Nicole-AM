...
@dataclass
class NicoleVLV2CausalLMOutputWithPast(ModelOutput):
    """
    Base class for Nicole-VL2 causal language model (or autoregressive) outputs.
...
class NicoleVLV2Config(PretrainedConfig):
    model_type = "nicole_vl_v2"
    vision_config: VisionEncoderConfig
    projector_config: MlpProjectorConfig
    language_config: NicoleV2Config
    ...
    def __init__(
        ...
        if isinstance(language_config, NicoleV2Config):
            self.language_config = language_config
        else:
            self.language_config = NicoleV2Config(**language_config)
...
class NicoleVLV2PreTrainedModel(PreTrainedModel):
    config_class = NicoleVLV2Config
    base_model_prefix = "nicole_vl_v2"
    _no_split_modules = []
    _skip_keys_device_placement = "past_key_values"


class NicoleVLV2ForCausalLM(NicoleVLV2PreTrainedModel):

    def __init__(self, config: NicoleVLV2Config):
        ...
        self.language = NicoleV2ForCausalLM(language_config)
...
AutoConfig.register("nicole_vl_v2", NicoleVLV2Config)
AutoModelForCausalLM.register(NicoleVLV2Config, NicoleVLV2ForCausalLM)
