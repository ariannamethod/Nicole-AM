...
class NicoleVLV2Processor(ProcessorMixin):
    ...
    def format_messages(
        ...
        Args:
            ...
            sft_format (str, optional): The format of the SFT template to use. Defaults to "nicole".
    ...
    def format_messages_v2(self, messages, pil_images, systems=None):
        ...
        assert len(images_spatial_crop) == len(
            num_image_tokens
        ), "image number should be compatible"
